...
- **Tier-4b ✅** Non-destructive snapshot/restore + `excel_diff` shipped.
- **Progressive discovery ✅** Optional BM25 `search_tools`/`call_tool` surface shipped; full 26-tool catalog remains the compatibility default.
